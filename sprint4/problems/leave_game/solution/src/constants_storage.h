...
struct JsonAttributes {
  ...
  constexpr static std::string_view LOOT_GENERATOR_CONFIG = "lootGeneratorConfig"sv;
  constexpr static std::string_view LOOT_CONFIG_PERIOD = "period"sv;
  constexpr static std::string_view LOOT_CONFIG_PROBABILITY = "probability"sv;
  ...
  constexpr static std::string_view DEFAULT_RETIREMENT_TIME = "dogRetirementTime"sv;

  constexpr static std::string_view USERNAME = "userName"sv;
  constexpr static std::string_view MAP_ID = "mapId"sv;

  constexpr static std::string_view TOKEN = "authToken"sv;
  constexpr static std::string_view PLAYER_ID = "playerId"sv;

  constexpr static std::string_view POS = "pos"sv;
  constexpr static std::string_view SPEED = "speed"sv;
  constexpr static std::string_view DIR = "dir"sv;
  constexpr static std::string_view BAG = "bag"sv;
  constexpr static std::string_view SCORE = "score"sv;
  ...
  constexpr static std::string_view PLAY_TIME = "playTime"sv;
};

struct HttpRequestConstants {

  HttpRequestConstants() = delete;

  constexpr static std::string_view START = "start"sv;
  constexpr static std::string_view MAX_ITEMS = "maxItems"sv;
};
...
struct HttpResponseConstants {
  ...
  constexpr static std::string_view CODE_INVALID_ARGUMENT = "invalidArgument"sv;
  constexpr static std::string_view CODE_MAP_NOT_FOUND = "mapNotFound"sv;

  constexpr static std::string_view GET_HEAD_EXPECTED = "Only GET, HEAD methods are expected"sv;
  constexpr static std::string_view ALLOWED_GET_HEAD = "GET, HEAD"sv;

  constexpr static std::string_view POST_EXPECTED = "Only POST method is expected"sv;
  constexpr static std::string_view ALLOWED_POST = "POST"sv;

  constexpr static std::string_view CODE_INVALID_METHOD = "invalidMethod"sv;

  constexpr static std::string_view MESSAGE_INVALID_NAME = "Invalid name"sv;
  constexpr static std::string_view MESSAGE_INVALID_MAP_ID = "Invalid mapId"sv;
  constexpr static std::string_view MESSAGE_INVALID_CONTENT_TYPE = "Invalid content type"sv;

  constexpr static std::string_view CODE_INVALID_TOKEN = "invalidToken"sv;
  constexpr static std::string_view MESSAGE_AUTH_HEADER_MISSING = "Authorization header is missing"sv;
  constexpr static std::string_view MESSAGE_INVALID_TOKEN = "Invalid token"sv;

  constexpr static std::string_view CODE_UNKNOWN_TOKEN = "unknownToken"sv;
  constexpr static std::string_view MESSAGE_TOKEN_NOT_FOUND = "Player token has not been found"sv;

  constexpr static std::string_view JOIN_GAME_PARSE_ERROR = "Join game request parse error"sv;
  constexpr static std::string_view JOIN_GAME_ERROR = "Error joining game"sv;
  constexpr static std::string_view PARSE_ACTION_ERROR = "Failed to parse action"sv;
  constexpr static std::string_view PARSE_TICK_ERROR = "Failed to parse tick request JSON"sv;
  ...
  constexpr static std::string_view MESSAGE_INVALID_ENDPOINT = "Invalid endpoint"sv;
