...
//  Players(std::vector<std::shared_ptr<Player>>&& players) : players_(std::move(players)) {
//    size_t i = 0;
//    for(auto &player : players_) {
//      token_to_player_index_.emplace(player->GetToken(), i);
//      player_id_to_player_index_.emplace(player->GetId(), i);
//      ++i;
//    }
//  }
