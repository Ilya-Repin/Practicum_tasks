...
class Dog {
 public:
  ...
  Dog(std::string name, double speed, Position start_point, size_t bag_capacity) noexcept
      : id_(++dog_counter_), name_(std::move(name)), default_speed_(speed), pos_(start_point), previous_position_(start_point), bag_capacity_(bag_capacity) {
  }
